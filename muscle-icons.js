...
// à la place de l'ancien simple rectangle plein utilisé par Grand Dorsal /
// Trapèzes & Rhomboïdes / Lombaires. Contrairement à la version précédente
// (grille abstraite), ces fragments sont construits directement à partir
// des sommets réels du contour #dosClip (silhouette du dos telle que
// définie dans app.html) : chaque quadrilatère relie le centre du buste à
// deux segments consécutifs du contour, donc le résultat suit exactement
// la forme du corps, comme un torse anatomique découpé en zones — au lieu
// d'un pavage générique.
const DOS_BG_FRAGMENTS = `
  <path d="M23.41,24.38 L23.38,1.2 L20.01,1.72 L19.1,6.2 Z"/>
  <path d="M23.41,24.38 L19.1,6.2 L9.85,11.16 L7.11,13.9 Z"/>
  <path d="M23.41,24.38 L7.11,13.9 L5.84,17.59 L5.92,22.59 Z"/>
  <path d="M23.41,24.38 L5.92,22.59 L2.67,28.15 L2.39,33.66 Z"/>
  <path d="M23.41,24.38 L2.39,33.66 L3.14,34.74 L5.84,34.26 Z"/>
  <path d="M23.41,24.38 L5.84,34.26 L11.8,29.97 L14.93,35.37 Z"/>
  <path d="M23.41,24.38 L14.93,35.37 L16.12,43.11 L24.62,46.8 Z"/>
  <path d="M23.41,24.38 L24.62,46.8 L31.96,43.07 L33.11,35.33 Z"/>
  <path d="M23.41,24.38 L33.11,35.33 L36.24,29.97 L41.09,33.74 Z"/>
  <path d="M23.41,24.38 L41.09,33.74 L44.42,34.74 L45.57,34.22 Z"/>
  <path d="M23.41,24.38 L45.57,34.22 L44.62,26.08 L42.16,22.59 Z"/>
  <path d="M23.41,24.38 L42.16,22.59 L42.24,17.19 L40.49,13.03 Z"/>
  <path d="M23.41,24.38 L40.49,13.03 L29.14,6.2 L28.31,1.76 Z"/>
  <path d="M23.41,24.38 L28.31,1.76 L23.38,1.2 L20.01,1.72 Z"/>
`;
...
const MUSCLE_ICONS = {
  ...
  // Trapèzes & Rhomboïdes — issu de l'ancienne icône "Dos", même
  // silhouette, surlignage étendu au kite central (trapèzes, du cou au
  // milieu du dos) et aux zones entre omoplates (rhomboïdes).
  'Trapèzes & Rhomboïdes': `
    <g clip-path="url(#dosClip)">
      <g fill="rgba(167,139,250,.20)" stroke="rgba(167,139,250,.85)" stroke-width="1.1" stroke-linejoin="round">${DOS_BG_FRAGMENTS}</g>
      <g filter="url(#muscleGlow)">
 ...
 * partage par 3 groupes distincts : 'Grand Dorsal', 'Trapèzes & Rhomboïdes'
