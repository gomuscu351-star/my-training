...
const MUSCLE_ICONS = {
  ...
  'Grand Dorsal': `
    <g clip-path="url(#dosClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M30.97,22.35 L28.58,25.21 L25.65,30.01 L31.8,36.8 L35.69,29.1 L36.36,24.69 L35.85,23.82 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M17.03,22.35 L12.23,23.82 L11.72,24.69 L12.43,29.22 L16.32,36.8 L22.39,30.05 L21.24,27.79 Z"/>
      </g>
    </g>
  `,
  ...
  'Trapèzes & Rhomboïdes': `
    <g clip-path="url(#dosClip)">
      <g fill="rgba(167,139,250,.20)" stroke="rgba(167,139,250,.85)" stroke-width="1.1" stroke-linejoin="round">${DOS_BG_FRAGMENTS}</g>
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M31.56,14.97 L30.85,17.87 L31.04,21.24 L31.56,21.64 L36.28,23.03 L36.56,22.59 L36.56,18.98 L36.08,17.15 L34.5,15.84 L32.08,14.89 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M16.48,14.93 L13.26,15.96 L11.92,17.27 L11.48,18.74 L11.48,22.59 L11.76,23.03 L16.44,21.68 L17.0,21.24 L17.23,18.11 L16.92,15.88 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M25.01,2.59 L24.54,7.43 L26.24,10.29 L24.5,13.11 L24.65,29.1 L29.93,21.68 L30.13,17.03 L31.2,13.66 L34.34,10.76 L28.62,7.35 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M23.19,2.59 L19.61,7.35 L13.82,10.76 L17.11,13.82 L18.19,21.84 L23.46,29.1 L23.66,12.95 L21.92,10.29 L23.62,7.51 Z"/>
      </g>
    </g>
  `,
  ...
  'Lombaires': `
    <g clip-path="url(#dosClip)">
      <g fill="rgba(167,139,250,.20)" stroke="rgba(167,139,250,.85)" stroke-width="1.1" stroke-linejoin="round">${DOS_BG_FRAGMENTS}</g>
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M24.73,30.69 L24.5,45.49 L25.09,45.81 L31.12,42.67 L31.48,38.23 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M23.07,30.69 L16.88,37.63 L16.68,39.46 L17.11,42.79 L23.35,45.81 L23.62,31.0 Z"/>
      </g>
    </g>
  `,
