 ...
 * panneau. Seule la palette a ete adaptee au theme de l'app (violet
 * discret pour le corps, degrade violet -> orange pour le muscle cible,
 * leger glow) a la place des couleurs brutes gris/rouge/orange des
 * references, pour rester coherent avec le reste de MyTraining.
 *
 ...
 * app.html) donc rien ne peut deborder.
 *
 * Usage :
...
const MUSCLE_ICONS = {
  ...
  'Pectoraux': `
    <g clip-path="url(#pectorauxClip)">
      <g fill="rgba(167,139,250,.18)" stroke="rgba(139,92,246,.4)" stroke-width="0.5" stroke-linejoin="round">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M25.07,14.76 L24.6,15.66 L24.6,20.38 L25.74,21.86 L32.17,23.83 L33.68,23.26 L35.79,21.29 L37.73,20.52 L35.42,15.83 L31.93,12.99 L29.49,12.72 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M22.96,14.76 L18.38,12.68 L15.96,13.05 L12.72,15.7 L10.34,20.55 L12.25,21.29 L14.53,23.36 L15.9,23.83 L22.46,21.79 L23.43,20.38 L23.43,15.7 Z"/>
      </g>
    </g>
  `,
  ...
  'Épaules': `
    <g clip-path="url(#epaulesClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M32.28,12.42 L35.12,14.16 L36.8,16.47 L38.47,20.02 L41.92,23.2 L42.25,17.58 L40.81,13.8 L38.94,12.29 L37.0,11.55 L34.66,11.65 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M15.72,12.42 L13.51,11.69 L11.04,11.55 L9.06,12.29 L7.29,13.7 L6.22,15.57 L5.75,17.68 L6.08,23.2 L9.83,19.62 L12.44,14.67 L13.98,13.23 Z"/>
      </g>
    </g>
  `,

  // Dos — tracé exactement depuis la référence fournie
  'Dos': `
    <g clip-path="url(#dosClip)">
      <g fill="rgba(167,139,250,.18)" stroke="rgba(139,92,246,.4)" stroke-width="0.5" stroke-linejoin="round">
        <path d="M39.85,21.96 L39.66,22.35 L40.57,24.58 L41.36,28.07 L43.31,31.72 L43.98,32.43 L44.46,32.43 L44.74,29.77 L43.86,26.44 L42.16,23.78 Z"/>
        <path d="M8.18,21.96 L5.88,23.74 L4.18,26.4 L3.26,29.93 L3.3,31.96 L3.66,32.47 L4.06,32.43 L4.81,31.6 L6.68,28.03 L7.35,24.89 L8.38,22.31 Z"/>
        <path d="M10.69,20.37 L9.42,21.88 L8.42,24.22 L7.71,29.22 L6.64,32.35 L6.88,32.87 L9.42,30.81 L10.88,28.23 Z"/>
        <path d="M37.39,20.33 L37.0,26.68 L37.2,28.35 L38.66,30.89 L40.33,32.51 L41.16,32.87 L41.4,32.39 L40.41,29.66 L39.62,24.26 L38.58,21.84 Z"/>
        <path d="M33.58,12.11 L32.39,13.38 L32.35,14.06 L36.08,15.84 L36.92,16.96 L37.59,19.06 L40.53,21.64 L41.16,21.64 L41.64,19.97 L41.6,17.23 L41.09,15.29 L40.05,13.5 L38.47,11.99 L36.68,11.12 L35.49,11.16 Z"/>
        <path d="M14.73,12.23 L13.07,11.28 L11.76,11.08 L10.09,11.76 L8.15,13.46 L7.11,15.17 L6.48,17.43 L6.44,20.05 L6.95,21.68 L7.51,21.64 L10.45,19.06 L11.12,16.92 L11.96,15.8 L15.8,13.98 L15.73,13.34 Z"/>
      </g>
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M24.73,30.69 L24.5,45.49 L25.09,45.81 L31.12,42.67 L31.48,38.23 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M23.07,30.69 L16.88,37.63 L16.68,39.46 L17.11,42.79 L23.35,45.81 L23.62,31.0 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M30.97,22.35 L28.58,25.21 L25.65,30.01 L31.8,36.8 L35.69,29.1 L36.36,24.69 L35.85,23.82 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M17.03,22.35 L12.23,23.82 L11.72,24.69 L12.43,29.22 L16.32,36.8 L22.39,30.05 L21.24,27.79 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M31.56,14.97 L30.85,17.87 L31.04,21.24 L31.56,21.64 L36.28,23.03 L36.56,22.59 L36.56,18.98 L36.08,17.15 L34.5,15.84 L32.08,14.89 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M16.48,14.93 L13.26,15.96 L11.92,17.27 L11.48,18.74 L11.48,22.59 L11.76,23.03 L16.44,21.68 L17.0,21.24 L17.23,18.11 L16.92,15.88 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M25.01,2.59 L24.54,7.43 L26.24,10.29 L24.5,13.11 L24.65,29.1 L29.93,21.68 L30.13,17.03 L31.2,13.66 L34.34,10.76 L28.62,7.35 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M23.19,2.59 L19.61,7.35 L13.82,10.76 L17.11,13.82 L18.19,21.84 L23.46,29.1 L23.66,12.95 L21.92,10.29 L23.62,7.51 Z"/>
      </g>
    </g>
  `,
  ...
  'Biceps': `
    <g clip-path="url(#bicepsClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M38.19,21.86 L37.63,22.69 L37.63,25.51 L38.55,28.8 L40.56,32.84 L42.04,34.41 L42.82,34.55 L43.32,33.95 L43.68,30.87 L43.42,28.5 L41.58,23.87 L38.78,21.83 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M10.07,21.86 L9.45,21.86 L6.65,23.93 L4.78,28.67 L4.55,30.54 L4.95,33.92 L5.44,34.55 L6.23,34.41 L7.41,33.23 L9.51,29.36 L10.63,25.51 L10.63,22.69 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M37.47,27.75 L37.44,29.03 L37.83,30.24 L38.75,31.79 L39.47,32.41 L39.51,32.25 L38.16,29.29 L37.67,27.81 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M10.76,27.75 L10.6,27.81 L8.79,32.41 L9.61,31.65 L10.53,30.01 L10.83,28.96 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M43.12,25.91 L44.17,28.86 L44.27,33.33 L44.57,33.49 L45.45,31.46 L45.26,29.45 L44.34,27.06 L43.61,26.17 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M5.14,25.91 L4.65,26.17 L3.83,27.22 L2.97,29.62 L2.88,31.85 L3.73,33.49 L3.96,33.4 L4.06,29.03 Z"/>
      </g>
    </g>
  `,
  ...
  'Triceps': `
    <g clip-path="url(#tricepsClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M39.32,21.53 L39.16,21.89 L40.1,24.27 L40.77,27.24 L42.61,30.82 L43.26,31.56 L43.71,31.62 L44.03,31.17 L44.03,28.91 L43.19,25.72 L41.26,22.89 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M8.71,21.53 L8.0,21.79 L6.52,23.15 L4.68,26.05 L3.94,29.53 L4.04,31.36 L4.29,31.62 L4.74,31.56 L5.55,30.62 L7.29,27.14 L8.0,23.98 L8.84,21.95 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M36.84,19.96 L36.68,27.05 L38.49,30.24 L40.13,31.88 L40.68,32.01 L40.9,31.59 L39.94,28.75 L39.32,24.02 L38.16,21.44 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M11.19,19.96 L10.03,21.15 L8.74,23.89 L8.1,28.72 L7.13,31.49 L7.42,32.04 L9.45,30.33 L11.29,27.21 Z"/>
      </g>
    </g>
  `,
  ...
  'Avant-bras': `
    <g clip-path="url(#avantBrasClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M16.29,23.58 L16.15,24.18 L16.75,25.61 L18.43,28.06 L22.11,30.41 L25.3,31.88 L25.75,31.74 L24.67,30.02 L18.64,24.42 L17.07,23.44 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M18.78,22.07 L18.61,22.42 L18.71,22.74 L20.85,25.12 L21.13,25.09 L21.16,24.74 L20.22,22.28 L19.8,22.0 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M21.3,19.62 L21.62,23.37 L23.61,27.29 L30.23,34.02 L32.09,33.98 L32.65,33.18 L32.55,32.02 L29.32,28.66 L26.1,23.33 L21.97,19.48 Z"/>
      </g>
    </g>
  `,
  ...
  'Abdominaux': `
    <g clip-path="url(#abdominauxClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="
Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M37.67,21.44 L36.65,31.38 L33.94,38.31 L33.94,40.56 L34.5,41.25 L35.16,41.09 L36.51,38.84 L38.0,33.59 L38.36,27.29 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M10.83,21.31 L9.9,26.86 L10.0,33.46 L11.09,38.31 L12.48,40.99 L13.1,41.22 L13.73,40.66 L13.86,38.38 L11.35,30.82 Z"/>
      </g>
    </g>
  `,
  ...
  'Ischio-jambiers': `
    <g clip-path="url(#ischioClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M30.62,23.04 L29.43,23.83 L27.0,37.34 L27.4,40.1 L29.82,45.44 L30.52,45.04 L31.72,32.63 L31.45,24.53 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M17.21,23.04 L16.38,24.17 L16.08,32.86 L17.21,44.71 L17.98,45.44 L20.43,40.0 L20.8,37.37 L18.37,23.9 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M32.61,22.21 L32.05,23.34 L32.98,38.77 L34.07,43.02 L35.3,44.68 L36.2,41.59 L36.89,34.45 L33.81,23.9 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M15.16,22.21 L14.03,23.8 L10.94,34.09 L11.44,40.53 L12.47,44.68 L13.53,43.51 L14.86,38.54 L15.79,23.0 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M25.28,21.98 L25.05,22.97 L26.07,34.22 L26.44,34.72 L28.33,23.9 L27.8,23.04 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M22.56,21.98 L20.0,23.04 L19.47,23.83 L21.26,34.69 L21.66,34.55 L22.79,22.47 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M35.53,15.27 L33.81,21.54 L37.42,31.2 L37.82,27.78 L37.52,21.88 L36.5,17.2 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M12.27,15.27 L11.24,17.4 L10.21,22.37 L9.98,27.78 L10.34,31.2 L13.99,21.58 Z"/>
      </g>
    </g>
  `,
  ...
  'Fessiers': `
    <g clip-path="url(#fessiersClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M33.49,6.48 L28.45,7.24 L25.89,8.87 L24.33,10.76 L24.33,18.92 L27.09,21.64 L28.65,22.04 L30.97,21.64 L32.99,19.42 L34.22,12.92 L34.16,7.51 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M14.31,6.48 L13.65,7.47 L13.55,12.15 L14.54,18.79 L16.37,21.41 L18.13,22.01 L20.22,21.84 L22.08,20.71 L23.44,19.02 L23.44,10.69 L19.98,7.54 L17.06,6.58 Z"/>
      </g>
    </g>
  `,
  ...
  'Mollets': `
    <g clip-path="url(#molletsClip)">
      <path fill="rgba(167,139,250,.18)" stroke="rgba(139,92,246,.4)" stroke-width="0.5" stroke-linejoin="round" d="M0,0 H48 V48 H0 Z"/>
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M29.9,9.71 L28.7,12.69 L28.39,16.14 L29.18,21.33 L29.83,23.32 L30.34,23.52 L30.79,22.39 L31.4,16.34 L30.89,12.1 L30.34,9.92 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M18.21,9.71 L17.59,10.26 L16.67,15.49 L16.87,19.66 L17.69,23.52 L18.21,23.35 L18.72,21.85 L19.64,16.41 L19.3,12.48 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M36.63,7.46 L35.06,11.32 L33.83,17.54 L33.55,32.37 L36.02,26.22 L37.18,20.79 L37.38,14.05 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" stroke-linejoin="round" d="M11.44,7.46 L10.65,14.29 L10.93,21.33 L12.09,26.43 L14.48,32.37 L14.17,17.2 L13.15,11.9 Z"/>
      </g>
    </g>
  `,
  ...
  'default': `
    <g filter="url(#muscleGlow)">
      <rect fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" x="3.4" y="20.4" width="7" height="7.2" rx="1.6"/>
      <rect fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" x="37.6" y="20.4" width="7" height="7.2" rx="1.6"/>
      <rect fill="url(#muscleIconGrad)" stroke="rgba(20,10,40,.35)" stroke-width="0.5" x="12.2" y="22.2" width="23.6" height="3.6" rx="1.4"/>
    </g>
  `,
};
 ...
 * #ischioClip / #fessiersClip / #molletsClip (voir le <svg> cache en tete
 * de <body>).
