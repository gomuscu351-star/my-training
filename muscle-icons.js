...
// utilisée par Grand Dorsal / Trapèzes / Lombaires. Ces panneaux sont issus
// d'un pavage anatomique (points d'ancrage placés sur les repères
// musculaires réels du dos — trapèzes, rhomboïdes, grand dorsal, érecteurs
// du rachis — puis cellules découpées et bornées par le contour exact de
// #dosClip) plutôt que d'un simple éventail de triangles depuis un point
// central : le résultat est irrégulier et organique, au même niveau de
// détail que les panneaux tracés à la main des icônes Pectoraux / Biceps /
// Triceps, au lieu d'un motif géométrique répétitif.
const DOS_BG_FRAGMENTS = `
  <path d="M23.31,8.8 L24.69,8.8 L27.23,1.64 L23.38,1.2 L20.76,1.6 Z"/>
  <path d="M18.77,10.51 L19.56,10.72 L23.31,8.8 L20.76,1.6 L20.01,1.72 L19.1,6.2 L16.63,7.53 Z"/>
  <path d="M31.36,7.54 L29.14,6.2 L28.31,1.76 L27.23,1.64 L24.69,8.8 L28.44,10.72 L29.23,10.51 Z"/>
  <path d="M18.77,10.51 L16.63,7.53 L9.85,11.16 L8.43,12.58 L11.77,14.36 Z"/>
  <path d="M29.23,10.51 L36.23,14.36 L39.66,12.53 L31.36,7.54 Z"/>
  <path d="M20.97,17.5 L19.56,10.72 L18.77,10.51 L11.77,14.36 L14.02,20.43 L17.38,22.21 Z"/>
  <path d="M36.23,14.36 L29.23,10.51 L28.44,10.72 L27.03,17.5 L30.62,22.21 L33.98,20.43 Z"/>
  <path d="M24.69,8.8 L23.31,8.8 L19.56,10.72 L20.97,17.5 L27.03,17.5 L28.44,10.72 Z"/>
  <path d="M29.62,25.0 L30.62,22.21 L27.03,17.5 L20.97,17.5 L17.38,22.21 L18.38,25.0 Z"/>
  <path d="M20.59,33.09 L24.0,35.18 L27.41,33.09 L29.7,25.3 L29.62,25.0 L18.38,25.0 L18.3,25.3 Z"/>
  <path d="M5.16,23.98 L14.02,20.43 L11.77,14.36 L8.43,12.58 L7.11,13.9 L5.84,17.59 L5.92,22.59 Z"/>
  <path d="M42.84,23.98 L43.09,23.9 L42.16,22.59 L42.24,17.19 L40.49,13.03 L39.66,12.53 L36.23,14.36 L33.98,20.43 Z"/>
  <path d="M18.38,25.0 L17.38,22.21 L14.02,20.43 L5.16,23.98 L9.02,29.0 L12.75,29.0 L18.3,25.3 Z"/>
  <path d="M30.62,22.21 L29.62,25.0 L29.7,25.3 L35.25,29.0 L38.98,29.0 L42.84,23.98 L33.98,20.43 Z"/>
  <path d="M9.02,29.0 L5.12,23.97 L2.67,28.15 L2.39,33.66 L3.14,34.74 L5.84,34.26 L7.84,32.82 Z"/>
  <path d="M43.09,23.9 L38.98,29.0 L40.23,33.08 L41.09,33.74 L44.42,34.74 L45.57,34.22 L44.62,26.08 Z"/>
  <path d="M20.59,33.09 L18.3,25.3 L12.75,29.0 L13.9,33.59 L14.98,35.68 Z"/>
  <path d="M35.25,29.0 L29.7,25.3 L27.41,33.09 L33.06,35.7 L34.08,33.66 Z"/>
  <path d="M18.46,44.13 L24.0,35.18 L20.59,33.09 L14.98,35.68 L16.12,43.11 Z"/>
  <path d="M27.41,33.09 L24.0,35.18 L24.0,35.43 L29.62,44.26 L31.96,43.07 L33.06,35.7 Z"/>
  <path d="M24.0,35.43 L18.46,44.13 L24.62,46.8 L29.62,44.26 Z"/>
  <path d="M7.84,32.82 L11.8,29.97 L13.9,33.59 L12.75,29.0 L9.02,29.0 Z"/>
  <path d="M38.98,29.0 L35.25,29.0 L34.08,33.66 L36.24,29.97 L40.23,33.08 Z"/>
`;
...
const MUSCLE_ICONS = {
  ...
  // Grand Dorsal — issu de l'ancienne icône "Dos", même silhouette
  // (dosClip + arrière-plan), seules les bandes latérales (lats) restent
  // surlignées.
  'Grand Dorsal': `
    <g clip-path="url(#dosClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M30.94,21.75 L30.47,21.94 L25.59,28.88 L25.5,29.53 L26.25,30.56 L31.59,36.38 L31.97,34.97 L32.81,33.28 L34.59,30.47 L35.44,28.69 L36.09,26.06 L36.19,23.72 L35.72,23.16 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M16.88,21.75 L11.91,23.25 L11.53,23.81 L11.72,26.44 L12.28,28.59 L13.31,30.75 L15.09,33.56 L15.84,35.16 L16.03,36.28 L16.22,36.38 L22.22,29.53 L22.03,28.59 L17.62,22.31 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M31.5,14.34 L31.12,15.0 L30.84,16.41 L30.84,17.06 L30.75,17.16 L30.75,19.69 L30.84,19.78 L30.84,20.44 L31.03,20.81 L31.41,21.09 L34.97,22.22 L35.53,22.5 L35.91,22.59 L36.19,22.5 L36.47,22.12 L36.47,18.28 L36.28,17.34 L35.81,16.41 L34.88,15.47 L34.03,15.0 L31.88,14.25 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M16.22,14.34 L15.84,14.25 L13.31,15.19 L12.75,15.56 L12.09,16.22 L11.72,16.78 L11.34,17.81 L11.34,21.56 L11.25,21.94 L11.34,22.31 L11.53,22.5 L11.81,22.59 L15.0,21.56 L15.28,21.38 L16.31,21.09 L16.78,20.72 L16.97,19.97 L16.97,16.97 L16.88,16.88 L16.88,16.31 L16.5,14.62 Z"/>
      </g>
    </g>
  `,

  // Trapèzes — issu de l'ancienne icône "Dos", même silhouette,
  // surlignage étendu au kite central (trapèzes, du cou au milieu du
  // dos) et aux zones entre omoplates (rhomboïdes, incluses dans ce
  // groupe).
  'Trapèzes': `
    <g clip-path="url(#dosClip)">
      <g fill="rgba(167,139,250,.20)" stroke="rgba(167,139,250,.85)" stroke-width="1.1" stroke-linejoin="round">${DOS_BG_FRAGMENTS}</g>
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M24.84,1.97 L24.28,2.25 L24.28,6.75 L24.84,8.25 L26.06,9.56 L24.75,10.88 L24.28,12.19 L24.38,28.59 L24.75,28.5 L29.81,21.09 L29.91,16.69 L30.94,13.31 L32.72,11.25 L34.22,10.22 L33.56,9.47 L28.5,6.84 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M22.78,1.97 L19.31,6.75 L13.78,9.66 L13.5,10.41 L15.19,11.44 L16.5,12.94 L17.72,16.41 L17.91,21.19 L22.78,28.31 L23.25,28.59 L23.34,11.91 L22.78,10.69 L21.56,9.56 L22.78,8.34 L23.34,6.94 L23.34,2.16 Z"/>
      </g>
    </g>
  `,

  // Lombaires — issu de l'ancienne icône "Dos", même silhouette, seul le
  // triangle du bas du dos reste surligné.
  'Lombaires': `
    <g clip-path="url(#dosClip)">
      <g fill="rgba(167,139,250,.20)" stroke="rgba(167,139,250,.85)" stroke-width="1.1" stroke-linejoin="round">${DOS_BG_FRAGMENTS}</g>
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M22.88,30.19 L16.69,37.03 L16.41,37.59 L16.59,42.09 L17.06,42.94 L19.59,43.41 L20.91,44.16 L22.88,45.84 L23.34,45.84 L23.53,45.47 L23.53,30.56 L23.25,30.19 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M24.56,30.19 L24.38,30.47 L24.38,45.56 L24.56,45.84 L25.03,45.84 L27.38,43.88 L28.88,43.22 L30.66,43.03 L31.03,42.75 L31.31,41.81 L31.5,37.69 L30.75,36.56 L25.12,30.28 Z"/>
      </g>
    </g>
  `,
  ...
  'Mollets': `
    <g clip-path="url(#molletsClip)">
      ...
      <g filter="url(#muscleGlow)">
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M29.9,9.71 L28.7,12.69 L28.39,16.14 L29.18,21.33 L29.83,23.32 L30.34,23.52 L30.79,22.39 L31.4,16.34 L30.89,12.1 L30.34,9.92 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M18.21,9.71 L17.59,10.26 L16.67,15.49 L16.87,19.66 L17.69,23.52 L18.21,23.35 L18.72,21.85 L19.64,16.41 L19.3,12.48 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M36.63,7.46 L35.06,11.32 L33.83,17.54 L33.55,32.37 L36.02,26.22 L37.18,20.79 L37.38,14.05 Z"/>
        <path fill="url(#muscleIconGrad)" stroke="rgba(15,8,28,.6)" stroke-width="0.9" stroke-linejoin="round" d="M11.44,7.46 L10.65,14.29 L10.93,21.33 L12.09,26.43 L14.48,32.37 L14.17,17.2 L13.15,11.9 Z"/>
      </g>
    </g>
  `,
 ...
 * de <body>). Le clipPath #dosClip (silhouette du dos) est desormais
